...
try {
    ...
    $mail->CharSet = 'UTF-8'; // Configura UTF-8 no PHPMailer
    $mail->Subject = 'Redefinição de Senha' . htmlspecialchars($usuario_nome, ENT_QUOTES, 'UTF-8');
...
<head>
    ...
    <link  href="css/envia_codigo.css" rel="stylesheet" >
