...
<head>
    ...
    <link  href="css/redefini_senha.css" rel="stylesheet" >
  ...
  <div class="container">
    <form method="POST" action="">
        ...
        <div class="password-container">
            <input type="password" name="nova_senha" placeholder="Digite a Nova Senha" id="nova_senha" required>
            <button type="button" class="toggle-password" onclick="togglePassword('nova_senha')">👁</button>
        </div>

        <label for="confirma_senha">Confirmar Senha:</label>
        <div class="password-container">
            <input type="password" name="confirma_senha" placeholder="Confirme a Nova Senha" id="confirma_senha" required>
        ...
        <button type="reset" class="limpa">Limpar</button>
    </form>
</div>
